...
def test_crop_invalid_input_range():
...
def test_irrigation_prediction_endpoint():
...
def test_pest_environmental_risk_endpoint():
...
def test_disease_image_predict_endpoint():
...
def test_disease_image_unsupported_type():
