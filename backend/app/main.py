...
from .api import market, weather, crop_calendar, decision, risk_opportunity, smart_alert, action_plan, farming_assistant
...
app.include_router(farming_assistant.router)
